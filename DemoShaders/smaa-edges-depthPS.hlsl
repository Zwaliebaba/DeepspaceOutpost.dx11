...
// SMAA edge detection (depth) -- pixel stage.
...
Texture2D colorTex : register(t0); // unused, kept to mirror GLSL binding layout
...
float4 PSMain(PSInput input) : SV_Target
{
    ...
    float2 edges = SMAADepthEdgeDetectionPS(input.texcoord, offset, depthTex);
